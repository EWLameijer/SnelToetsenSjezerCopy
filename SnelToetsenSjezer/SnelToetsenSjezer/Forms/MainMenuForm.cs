...
public partial class MainMenuForm : Form
{
    ...
    public static HotKeyGameService? MyHotKeyGameService = new();

    public static List<string> AllCategories = new();
    public static List<string> SelectedCategories = new();
    public static List<HotKey> HotKeysInSelectedCategories = new();
